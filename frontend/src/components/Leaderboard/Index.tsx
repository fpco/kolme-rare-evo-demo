...
const Leaderboard = ({ data }: LeaderboardProps) => {
  ...
  return (
    <Card id="leaderboard" className="w-full md:w-1/3 bg-black/30 rounded-xl flex flex-col h-full">
      ...
      <div className="flex-1 min-h-[600px] flex flex-col">
        {data.length === 0 ? (
          <div className="text-center py-8 flex-1 flex flex-col justify-center">
            ...
            <h4 className="text-xl font-semibold text-gray-300 mb-2">No Players Yet</h4>
            <p className="text-gray-400 text-sm">
              Be the first to join the game and claim your spot on the leaderboard!
            </p>
          </div>
        ) : (
